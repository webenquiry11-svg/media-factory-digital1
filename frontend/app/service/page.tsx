    ...
    <section className="py-24 bg-white font-sans overflow-hidden">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        >
          <div className="max-w-3xl">
            ...
            <h2 className="text-4xl lg:text-[3.5rem] font-bold text-[#0F172A] leading-[1.15]">
              Provides Full-Cycle Custom IT <br className="hidden lg:block" />
        ...
        >
          ...
          <motion.div variants={cardVariants} className="bg-[#FFF5F7] rounded-[2.5rem] p-10 flex flex-col justify-between h-[520px] relative overflow-hidden group hover:shadow-xl transition-all duration-300">
            <div className="relative z-10">
                <p className="text-[#E11D48] font-bold text-sm tracking-wide mb-3 uppercase">Excellent Performance</p>
            ...
            <div className="absolute bottom-0 left-0 w-full h-[220px]">
                <svg className="w-full h-full" viewBox="0 0 400 220" preserveAspectRatio="none">
                    ...
                    <path d="M0 180 L 80 160 L 160 180 L 240 100 L 320 120 L 400 20 L 400 220 L 0 220 Z" fill="url(#pinkGradient)" />
                    <path d="M0 180 L 80 160 L 160 180 L 240 100 L 320 120 L 400 20" fill="none" stroke="#E11D48" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                    <circle cx="80" cy="160" r="4" fill="white" stroke="#E11D48" strokeWidth="2" />
                    <circle cx="240" cy="100" r="4" fill="white" stroke="#E11D48" strokeWidth="2" />
                    <circle cx="320" cy="120" r="4" fill="white" stroke="#E11D48" strokeWidth="2" />
                </svg>
            </div>
          </motion.div>

          {/* 2. Website Design (Center - Spans 2 Rows) */}
          <motion.div variants={cardVariants} className="bg-[#EFF6FF] rounded-[2.5rem] p-10 flex flex-col justify-between relative overflow-hidden group hover:shadow-xl transition-all duration-300 lg:row-span-2 h-auto min-h-[520px]">
             <div className="absolute top-8 right-8 w-10 h-10 rounded-full border border-blue-200"></div>

             <div className="relative z-10">
                <p className="text-[#2563EB] font-bold text-sm tracking-wide mb-3 uppercase">Excellent Performance</p>
                <h3 className="text-3xl font-bold text-[#0F172A] leading-tight mb-8">
                  Website <br /> Design & <br /> Development
                </h3>
          ...
          <motion.div variants={cardVariants} className="bg-[#F8FAFC] rounded-[2.5rem] p-10 flex flex-col justify-between h-[520px] relative overflow-hidden group hover:shadow-xl transition-all duration-300 border border-slate-100">
            <div className="relative z-10">
                <p className="text-[#4F46E5] font-bold text-sm tracking-wide mb-3 uppercase">Excellent Performance</p>
                <h3 className="text-3xl font-bold text-[#0F172A] leading-tight mb-8">
                  CRM Software <br /> Solution
                </h3>
                    ...
                    <div className="flex gap-6 h-full items-end pb-4">
                        <div className="w-3/5">
                            <div className="flex justify-between items-end mb-3">
                                <div>
                                    <p className="text-[10px] text-slate-400 font-medium">Daily Traffic</p>
                                    <p className="text-2xl font-bold text-slate-800">2.579</p>
                                </div>
                                <span className="text-[10px] text-green-500 font-bold bg-green-50 px-1.5 py-0.5 rounded">+2.45%</span>
                            </div>
                        ...
                        <div className="absolute -top-12 right-12 bg-white p-3 rounded-2xl shadow-lg border border-slate-50 w-28 h-28 flex flex-col items-center justify-center">
                            <p className="text-[8px] text-slate-400 font-bold mb-1 w-full text-left">Pie Chart</p>
                            <div className="relative w-12 h-12">
                                <svg viewBox="0 0 32 32" className="w-full h-full -rotate-90">
                                    <circle cx="16" cy="16" r="16" fill="#EEF2FF" />
                                    <circle cx="16" cy="16" r="8" fill="transparent" stroke="#6366F1" strokeWidth="16" strokeDasharray="75 100" />
                                </svg>
                            </div>
                        </div>
                    </div>
          ...
          <motion.div variants={cardVariants} className="bg-[#F0FDF4] rounded-[2.5rem] p-10 flex flex-col justify-between h-[520px] relative overflow-hidden group hover:shadow-xl transition-all duration-300">
            <div className="relative z-10">
                <p className="text-[#16A34A] font-bold text-sm tracking-wide mb-3 uppercase">Excellent Performance</p>
                <h3 className="text-3xl font-bold text-[#0F172A] leading-tight mb-8">
          ...
          <motion.div variants={cardVariants} className="bg-[#FAF5FF] rounded-[2.5rem] p-10 flex flex-col justify-between h-[520px] relative overflow-hidden group hover:shadow-xl transition-all duration-300">
            <div className="relative z-10">
                <p className="text-[#9333EA] font-bold text-sm tracking-wide mb-3 uppercase">Excellent Performance</p>
                <h3 className="text-3xl font-bold text-[#0F172A] leading-tight mb-8">
                  Cloud <br /> Solutions
                </h3>
            ...
            <div className="absolute bottom-0 left-0 w-full h-[220px] flex items-end justify-center">
                 <div className="relative w-full h-full">
                     ...
                     <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center">
                         <Cloud size={80} className="text-[#9333EA] fill-purple-100" strokeWidth={1} />
