...
const WorkingRoadmap = () => {
  ...
  const servicesData = [
    ...
    },
    {
      ...
      icon: Palette,
      bgColor: 'bg-[#4B5563]',
      borderClass: 'border border-slate-600',
      textClass: 'font-semibold text-xs text-slate-200',
      shadowClass: 'shadow-2xl',
    ...
    },
    {
      ...
      icon: Package,
      bgColor: 'bg-[#6B7280]',
      borderClass: 'border-4 border-[#0B0F19] shadow-slate-500/20',
      textClass: 'font-semibold text-sm text-white',
      shadowClass: 'shadow-2xl',
      positionClass: 'md:-translate-y-8',
      floatDuration: 4.2,
    ...
    },
    {
      ...
      icon: Glasses,
      bgColor: 'bg-[#0369A1]',
      borderClass: 'border border-slate-500',
      textClass: 'font-semibold text-xs text-white',
      shadowClass: 'shadow-2xl',
      positionClass: 'md:translate-y-12',
      floatDuration: 5.5,
      floatDelay: 0.6,
